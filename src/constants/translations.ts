...
const translations: Record<LanguageCode, Record<TranslationKey, string>> = {
  ...
  'zh-CN': {
    ...
    // 主页
    'hero.title': '找工作，发招聘，一站搞定',
    'hero.subtitle': '不用再在各个招聘网站来回切换了，在Glint就能管理所有平台的招聘信息',
    'platform.title': '一次发布，多平台同步',
    'platform.subtitle': '支持主流招聘平台的职位同步与管理',
    'ai.title': 'AI智能匹配，提高招聘效率',
    'ai.subtitle': '让招聘更智能，更高效',
    'ai.feature1.title': '智能评分系统',
    'ai.feature1.description': '自动分析简历与职位的匹配度，帮助企业快速找到最合适的候选人',
    'ai.feature2.title': '效率提升50%',
    'ai.feature2.description': '减少筛选简历的时间，让HR专注于与优质候选人的沟通',
    'translation.title': '跨语言沟通无障碍',
    'translation.subtitle': '简历、消息、视频面试，全程实时翻译',
    'translation.resume.title': '简历翻译',
    'translation.resume.description': '自动识别简历语言并翻译成目标语言，保留专业术语准确性',
    'translation.message.title': '实时消息翻译',
    'translation.message.description': '与候选人的沟通消息自动翻译，支持多种语言互译',
    'translation.interview.title': '视频面试翻译',
    'translation.interview.description': '面试过程中的实时语音翻译，让跨语言面试更顺畅',
    'cost.title': '降低招聘成本，提高招聘效率',
    'cost.subtitle': '智能招聘解决方案',
    'cost.saving.title': '降低招聘成本',
    'cost.saving.description': '通过AI智能匹配和多平台整合，帮助企业节省40%招聘成本',
    'cost.time.title': '缩短招聘周期',
    'cost.time.description': '自动化流程和智能筛选，将招聘时间缩短50%',
    'cta.title': '准备好开始了吗？',
    'cta.try': '免费试用',
    'cta.contact': '联系我们',
    'footer.slogan': 'Glint - 让全球招聘变得简单',
  ...
  'zh-TW': {
    ...
    'hero.subtitle': '不用再在各個招聘網站來回切換了，在Glint就能管理所有平台的招聘信息',
